...
<script type="text/javascript" language="javascript" src="jquery.js"></script>  
    <script type="text/javascript" language="javascript">   
        ...
        function fun(n) {  
            var url = "sever.php"; 
			var phone=getElementById(num).value;
			var youxiang=getElementById(email).value;
			var mima=getElementById(password).value;
            var data = {  
                action : n.value, 
				phoneinfo:phone,
				emailinfo:youxiang,
    ...
    <div class="zhuce_kong">
    	<div class="zc">
            ...
            <h3>欢迎注册</h3>
                ...
                <input name="注册" type="button" class="btn_zhuce" value="注册" onclick="fun(this)">
