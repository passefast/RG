...
<div class="container">
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<div class="carousel slide" id="carousel-793562">
				<ol class="carousel-indicators">
					<li class="active" data-slide-to="0" data-target="#carousel-793562">
					</li>
					<li data-slide-to="1" data-target="#carousel-793562">
					</li>
					<li data-slide-to="2" data-target="#carousel-793562">
					</li>
				</ol>
				...
				</div> <a class="left carousel-control" href="#carousel-793562" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"></span></a> <a class="right carousel-control" href="#carousel-793562" data-slide="next"><span class="glyphicon glyphicon-chevron-right"></span></a>
			</div>
		</div>
	</div>
	<div class="row clearfix">
